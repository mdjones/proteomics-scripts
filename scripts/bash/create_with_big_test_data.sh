...
CMD="${PYTHON} ${ANALYZE_QUANT_SCRIPT} ${TEST_DATA_DIR}/peptideList_EN80.csv ${TEST_DATA_DIR}/results_EN80.csv"
echo ${CMD}
${CMD}

CMD="${PYTHON} ${ANALYZE_QUANT_SCRIPT} -v ${TEST_DATA_DIR}/peptideList_EN80.csv ${TEST_DATA_DIR}/resultsverbose_EN80.csv"
echo ${CMD}
${CMD}